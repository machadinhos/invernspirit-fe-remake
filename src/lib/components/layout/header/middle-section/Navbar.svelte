...
<nav class="mt-5">
  <ul class="flex h-full items-center gap-32 text-xl">
        ...
        <div class="flex flex-col items-center justify-center gap-4 py-4 text-2xl">
          <DropdownMenuItem>
            <a
              ...
              onclick={() => (isOpen = false)}>{common.header.middleSection.shop.byCollection}</a
            >
          </DropdownMenuItem>
    ...
    <NavbarItem>
      <a href="/{page.params.country}/about">{common.header.middleSection.about}</a>
    </NavbarItem>
    <li>
    ...
    <NavbarItem>
      <a href="/{page.params.country}/contact-us">{common.header.middleSection.contactUs}</a>
    </NavbarItem>
    <NavbarItem>
      <a class="h-full" href="/{page.params.country}/faq">{common.header.middleSection.faq}</a>
    </NavbarItem>
  </ul>
</nav>
